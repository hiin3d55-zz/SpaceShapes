...
public class ShapeModel {
	...
	public ShapeModel(Dimension bounds) {
		_root = new CarrierShape(0, 0, 0, 0, bounds.width, bounds.height);
		_bounds = bounds;
		_listeners = new ArrayList<ShapeModelListener>();
	}

	/**
	 * Returns the root CarrierShape of this ShapeModel object.
	 */
	public CarrierShape root() {
		return _root;
	}
	
	/**
	 * Attempts to add a new Shape to a specified CarrierShape held within the
	 ...
	 * shape is too large to fit into the CarrierShape or that the shape is
	 * already part of a CarrierShape. If the shape can be added, it is and
	 ...
	 */
	public boolean add(Shape shape, CarrierShape parent) {
	 ...
	 * being fired; the event identifies the root CarrierShape.
	 */
	public void clock() {
	...
	/**
	 * De-registers a ShapeModelListener from this ShapeModel object.
	 */
