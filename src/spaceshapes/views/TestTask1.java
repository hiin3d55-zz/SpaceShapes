...
public class TestTask1 {
	...
	private CarrierShape _emptyNest;
	...
	public void setUpShapeModel() {
		...
		_root = model.root();
		_emptyNest = new CarrierShape(0, 0, 2, 2, 100, 100);
	...
	/**
	 * Checks whether getRoot() returns the root CarrierShape of a the 
	 * ShapeModel as expected.
	 */
	@Test
	public void test_getRoot() {
		CarrierShape nest = ( CarrierShape )_adapter.getRoot();
		assertSame( _root, nest );
	}
	
	/**
	 * Checks whether getChildCount() returns zero for an empty CarrierShape.
	 */
	@Test
	 ...
	 * an empty CarrierShape as argument.
	 */
	@Test
	...
	/**
	 * Checks whether isLeaf() returns false, as required, when supplied with
	 * a CarrierShape that contains children.
	 */	
	@Test
	 ...
	 * a reference to a CarrierShape and the index position within the
	 * CarrierShape's collection of children that identifies the child Shape 
	 ...
	 * CarrierShape, which is the first argument.
	 */
	@Test
	 ...
	 * the CarrierShape supplied as the first argument.
	 */
	@Test
	 ...
	 * a Shape (second argument) that is a child of a CarrierShape (the first 
	 * argument).
	 */
	@Test
